...
public class TcsQuestion {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < NUM_SUBJECTS; i++) {
			while (true) {
				System.out.print("Enter marks for subject " + (i + 1) + " (0 to " + MAX_MARKS + "): ");
				...
				if (marks[i] >= 0 && marks[i] <= MAX_MARKS) {
					...
					System.out.println("Invalid input. Please enter marks between 0 and " + MAX_MARKS + ".");
				}
			}
		}
		...
		System.out.println("\nTotal Marks: " + totalMarks + " / " + (NUM_SUBJECTS * MAX_MARKS));
